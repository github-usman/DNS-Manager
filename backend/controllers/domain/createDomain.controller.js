...
export const createHostedZone = async (req, res,isDomainExist,client,CreateHostedZoneCommand) => {
    try {
        ...
        console.log((responses.length === 0)?'No domain is created because all are already exist':`these Hosted zones created successfully ${responses}`);
    } catch (error) {
