        ...
        <h1 style={{textAlign:'center'}}>List of DNS Records </h1>
            {/* schema */}
               <div className={styles.schema}>
                    <p className={styles.schemaCellLeft} style={{width:'300px'}}>Name</p>
                    <p className={styles.schemaCell} style={{width:'100px'}}> Type</p>
                    <p  className={styles.schemaCell}  style={{width:'100px'}}> TTL</p>
